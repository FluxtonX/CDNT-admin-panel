...
// ─── Brevo email helper (matches pattern used in deposits/withdrawals routes) ───
    ...
    <tr>
      <td align="center">
        <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;background:#FFFFFF;border-radius:16px;border:1px solid #E2E8F0;overflow:hidden;">
          ...
          <!-- Header -->
          <tr>
            <td style="background:linear-gradient(135deg,#0A3D91 0%,#1650AB 100%);padding:28px 36px;text-align:center;">
              <p style="margin:0;color:#FFFFFF;font-size:22px;font-weight:bold;letter-spacing:-0.3px;">CDNT Bank</p>
          ...
          <tr>
            <td style="padding:20px 36px 32px;">
              ...
              <div style="background:#F8FAFC;border-left:4px solid #1650AB;border-radius:0 8px 8px 0;padding:16px 20px;margin-bottom:24px;">
          ...
          <tr>
            <td style="background:#F8FAFC;border-top:1px solid #E2E8F0;padding:20px 36px;text-align:center;">
              <p style="margin:0;color:#94A3B8;font-size:12px;">This is an automated message from the CDNT Bank admin team.</p>
              <p style="margin:4px 0 0;color:#94A3B8;font-size:11px;">&copy; Canadian National Trust Bank. All rights reserved.</p>
            </td>
          </tr>
