...
function LiveChatSupportPageContent() {
    ...
    const messagesChannel = supabase
      ...
      .on(
        ...
        (payload) => {
          ...
          // Only clear unread on INSERT events
  ...
  /* Delete Message for Everyone (optimistic) */
  ...
  /* Delete Message for Me Only (optimistic) */
          ...
          <div className={cn("w-full md:w-[320px] shrink-0 border-r border-gray-200 flex flex-col bg-gray-50/20", activeThreadId ? "hidden md:flex" : "flex")}>
            ...
            <div className="p-4 border-b border-gray-200 bg-white">
              <div className="relative">
                ...
                {searching && <Loader2 className="absolute right-3.5 top-1/2 h-3.5 w-3.5 -translate-y-1/2 text-blue-500 animate-spin" />}
                <input
                  value={search}
                  onChange={async (e) => {
                  ...
                  className="h-10 w-full rounded-xl border border-gray-200 bg-gray-50 pl-10 pr-8 text-xs text-gray-800 outline-none transition-all placeholder:text-gray-500 focus:border-blue-400 focus:bg-white focus:ring-2 focus:ring-blue-50"
                />
              </div>
                    ...
                    return (
                      ...
                      >
                        ...
                        <span className={cn(
                          ...
                          hasThread ? "bg-gray-100 text-gray-600" : "bg-blue-600 text-white"
                        )}>
                          {hasThread ? "Open" : "New"}
                        </span>
                      </button>
                              ...
                              <div className="flex flex-col gap-2 min-w-[180px]">
                                ...
                                <div className="flex gap-2 justify-end">
                                  <button
                                    ...
                                    className="px-2 py-1 text-[10px] bg-blue-800 hover:bg-blue-950 text-white rounded font-bold transition-all"
                                  >
                                    Cancel
                                  </button>
                                  <button
                                    ...
                                    className="px-2 py-1 text-[10px] bg-white text-blue-800 hover:bg-gray-100 rounded font-bold transition-all"
                                  >
                                    Save
                                  </button>
                                </div>
                              ...
                              <>
                                ...
                                {msg.is_edited && (
                                  <span className={cn(
                                    ...
                                    isAdmin ? "text-blue-100/70" : "text-gray-400"
                                  )}>Edited</span>
                                )}
                              </>
                            )}
